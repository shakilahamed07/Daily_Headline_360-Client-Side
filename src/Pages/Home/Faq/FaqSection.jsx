        ...
        >
          ...
          <div className="collapse bg-base-100 border border-base-400">
            ...
            <div className="collapse-content text-sm">
              Yes! All basic features and most articles are free. You can also
              explore premium content by subscribing.
            </div>
          </div>
          ...
          <div className="collapse bg-base-100 border border-base-400">
            ...
            <div className="collapse-content text-sm">
              Click on the "Subscribe" button from the homepage or visit the
              Subscription page to choose your plan.
            </div>
          </div>
          ...
          <div className="collapse bg-base-100 border border-base-400">
            ...
            <div className="collapse-content text-sm">
              Our editorial team verifies all news before publishing, and we
              rely on trusted sources only.
            </div>
          </div>
          ...
          <div className="collapse bg-base-100 border border-base-400">
            ...
            <div className="collapse-content text-sm">
              Yes! if you a normal user you can one article post. But if you
              premium user you can unlimited article post.
            </div>
          </div>
        </div>
      </div>
