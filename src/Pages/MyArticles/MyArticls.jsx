              ...
              <tr key={article._id}>
                ...
                <td>
                  {article.status === "decline" ? (
                    ...
                    <span className={
                      article.status === "approved" ? "text-green-600" : "text-yellow-600"
                    }>
                ...
                <td className="space-x-2">
                  <button className="btn btn-xs btn-info" onClick={() => navigate(`/article/${article._id}`)}>
                    Details
                  </button>
                  <button className="btn btn-xs btn-warning my-2" onClick={() => navigate(`/update-article/${article._id}`)}>
                    Update
                  </button>
                  <button className="btn btn-xs btn-error" onClick={() => handleDelete(article._id)}>
                    Delete
                  </button>
                </td>
              </tr>
